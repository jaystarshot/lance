...
def write_dataset(
    ...
    *,
    ...
    data_path_uris: Optional[List[str]] = None,
    target_path_uri: Optional[str] = None,
) -> LanceDataset:
    ...
    data_path_uris: list of str, optional
    ...
    params = {
        ...
        "data_path_uris": data_path_uris,
        "target_path_uri": target_path_uri,
    }
